<template>
    <el-popover
        ...
        v-model="visible">
        <div class="userinfo-con" v-loading="loading">
            <div v-if="visible">
                <div class="info-header" >
                    <div class="auth-con">
                        <img class="avatar" :src="userinfo.profile.avatarUrl"/>
                        <span class="nickname">{{userinfo.profile.nickname}}</span>
                        <div class="sign" :class="{'is-sign':userinfo.pcSign}" @click="signin">{{userinfo.pcSign ? '已' : ''}}签到</div>
                    </div>
                    <div class="tag-con">
                ...
                <div class="line"></div>
                <div class="user-info-list" v-for="(list,index) in userList" :key="index">
                    <div class="list-item" v-for="(item,itemIndex) in list" :key="itemIndex">
                       <div class="item-left" @click="handle(item.name)">
